...
def dataset_test():
    ...
    with open(file, encoding="utf-8") as f:
        ...
        for line in f:
            ...
            #sql_e1_a0 = "select * from nlpccQA where entity='" + entity + "' and attribute like '%" + attribute + "%' limit 10"
...
def estimate_answer(candidate, answer):
    ...
    if not answer.isdigit() and candidate.isdigit():
        candidate_temp = "{:.5E}".format(int(candidate))  # 50变成了5.00000E+01
        ...
        for line in f:
            try:
                ...
                if len(result_e0_a1) > 0:
                    ...
                    # l1[2]: answer
                    flag_ambiguity = True
                    for l in result_e0_a1:  # l是从数据库中查出来的所有符合实体的三元组
