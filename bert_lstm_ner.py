...
if os.name == 'nt':   # 如果使用的是windows
    bert_path = 'D:/aidoctor/project/BERT/chinese_L-12_H-768_A-12'
    root_path = 'D:/aidoctor/project/my_kbqa'
else:
    bert_path = '/home/zhangyao/bert/chinese_L-12_H-768_A-12'
    root_path = '/home/zhangyao/NER_BERT-BiLSTM-CRF'

flags.DEFINE_string(
    "data_dir", os.path.join(root_path, 'NER_Data'),
    "The input datadir.",
)
...
flags.DEFINE_string(
    "output_dir", os.path.join(root_path, 'Output/NER'),
...
class NerProcessor(DataProcessor):
    ...
    def get_dev_examples(self, data_dir):
        return self._create_example(
            ...
            self._read_data(os.path.join(data_dir, "testing.txt")), "dev"
        )
